...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		show: function (e) {
			...
			$('.datetimepicker').hide();
			$('.dropdown-select-open').removeClass('dropdown-select-open');
		...
		hide: function (e) {
			...
			this.element.closest('.dropdown-select').removeClass('dropdown-select-open');
			this.picker.hide();
		...
		fill: function () {
			...
			this.picker.find('tfoot th.today')
				.html('<div class="today-btn">'+dates[this.language].today+'</div>')
			...
			while (prevMonth.valueOf() < nextMonth) {
				...
				html.push('<td class="day' + clsName + '"><em>' + prevMonth.getUTCDate() + '</em></td>');
	...
	var DPGlobal = {
		...
		headTemplate:     '<thead>' +
							  '<tr>' +
							  '<th class="prev"><i class="fz fz-arrow-left"></i></th>' +
							  '<th colspan="5" class="switch"></th>' +
							  '<th class="next"><i class="fz fz-arrow-right"></i></th>' +
							  '</tr>' +
			'</thead>',
